...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("API.Schema.MangaContext.BundleChapterMap", b =>
                {
            ...
            modelBuilder.Entity("API.Schema.MangaContext.MetadataSource", b =>
                {
                    b.Property<string>("MangaId")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("API.Schema.MangaContext.VolumeMetadata", b =>
                {
                    b.Property<string>("Key")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)");
            ...
            modelBuilder.Entity("API.Schema.MangaContext.BundleChapterMap", b =>
                {
                    ...
                    b.HasOne("API.Schema.MangaContext.VolumeMetadata", "Volume")
                        .WithMany()
            ...
            modelBuilder.Entity("API.Schema.MangaContext.MetadataSource", b =>
                {
                    b.HasOne("API.Schema.MangaContext.Manga", "Manga")
                        ...
                        .HasForeignKey("API.Schema.MangaContext.MetadataSource", "MangaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
