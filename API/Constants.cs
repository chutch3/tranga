...
public struct Constants
{
    ...
    public static readonly TimeSpan DependencyPollInterval = TimeSpan.FromSeconds(int.Parse(Environment.GetEnvironmentVariable("DEPENDENCY_POLL_INTERVAL_SECONDS") ?? "1"));
